...
"""Testing blackbox Inv-GAN models_art. This module is based on MNIST tutorial
of cleverhans."""
...
if __name__ == '__main__':
    ...
    # ISSUE: the classifiers provided by authors only contain model A - other models_art need to be trained
    # flags.DEFINE_string("bb_model", 'A',
    #                     "The architecture of the classifier model.")
    # flags.DEFINE_string("sub_model", 'A', "The architecture of the substitute model.")
    # flags.DEFINE_boolean("load_bb_model", True, "True for loading from saved bb models_art [False]")
    # flags.DEFINE_boolean("load_sub_model", True, "True for loading from saved sub models_art [False]")
